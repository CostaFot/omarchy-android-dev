...
`README.md`, `TODO.md`, `LICENSE` from the 2026-09-05 scaffold. `TODO.md` is superseded by the plan file; Session 1 folds it into this file's roadmap and `IDEAS.md` and deletes it.

## Roadmap (one session each; details in the plan file)

1 repo docs + Python core (terminal only) · 2 service, bar widget, hub · 3 devices, packages, actions, deep links · 4 toggles, screenshot, screen record · 5 APK manager, send text, tools · 6 settings page, IPC, keybinding docs · 7 release polish 1.0.0 · 8 publish (marketplace, projects page, blog draft)
